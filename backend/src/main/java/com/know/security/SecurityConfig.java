...
public class SecurityConfig {
  ...
  @Bean
  SecurityFilterChain chain(HttpSecurity http, @Value("${app.jwt-secret}") String secret)
      throws Exception {
  ...
  static class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest r, HttpServletResponse res, FilterChain f)
