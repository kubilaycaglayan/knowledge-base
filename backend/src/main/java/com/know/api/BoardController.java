...
public class BoardController {
  ...
  record StatusView(UUID id, String name, int position, boolean archived, BoardCardSort cardSort) { static StatusView of(BoardStatus s) { return new StatusView(s.getId(), s.getName(), s.getPosition(), s.isArchived(), s.getCardSort()); } }
