...
public class LabelController {
  ...
  public LabelController(LabelManagementService service) { this.service = service; }
  record Request(@NotBlank @Size(max = 80) String name, @Pattern(regexp = "^#[0-9A-Fa-f]{6}$") String color, Set<LabelScopeType> scopes) {}
