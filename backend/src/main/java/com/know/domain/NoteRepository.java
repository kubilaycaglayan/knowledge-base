...
public interface NoteRepository extends JpaRepository<Note, UUID> {
  ...
  Page<Note> findAllByUserIdOrderByUpdatedAtDescIdDesc(UUID userId, Pageable page);
  ...
  Page<Note> findAllByUserIdAndTitleContainingIgnoreCaseOrUserIdAndContentTextContainingIgnoreCase(
      UUID userId, String title, UUID sameUserId, String content, Pageable page);
}
