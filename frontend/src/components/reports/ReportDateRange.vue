...
watch(
  ...
  ([startDate, endDate]) => {
    if (
      format(dates.value[0], "yyyy-MM-dd") !== startDate ||
      format(dates.value[1], "yyyy-MM-dd") !== endDate
    )
      dates.value = [parseISO(startDate), parseISO(endDate)];
  },
);
...
const presets: PresetDate[] = [
  ...
  },
  {
    ...
    value: [
      ...
      endOfWeek(subWeeks(currentDate, 1), { weekStartsOn: 1 }),
    ],
  },
  ...
  },
  {
    ...
    value: [
      ...
      endOfQuarter(subQuarters(currentDate, 1)),
    ],
  },
  {
    label: "Year",
  ...
  },
  {
    ...
    value: [
      ...
      endOfYear(subYears(currentDate, 1)),
    ],
  },
];
const formats = {
