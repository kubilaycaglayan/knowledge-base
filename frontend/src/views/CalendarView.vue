...
function startRange() { selectingRange.value = true; rangeStart.value = null; rangeEnd.value = null; }
function cancelRange() { selectingRange.value = false; rangeStart.value = null; rangeEnd.value = null; selectDay(parseISO(selected.value)); }
onMounted(load);
</script>
