...
.note-list { border-top: 1px solid var(--workspace-border); }.note-row { width: 100%; display:flex; justify-content:space-between; gap:20px; text-align:left; border:0; border-bottom:1px solid var(--workspace-border); padding:18px 0; background:transparent; }.note-row:hover { background:var(--workspace-surface); }.note-row-main { min-width:0; display:grid; gap:7px; }.note-row-main strong { font-size:16px; }.note-row-main span { color:var(--workspace-muted); white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }.note-row-meta { display:grid; justify-items:end; gap:8px; color:var(--workspace-muted); font-size:12px; white-space:nowrap; }.note-tags { display:flex; flex-wrap:wrap; justify-content:flex-end; gap:5px; }.note-tags i, .note-tag { font-style:normal; color:var(--workspace-muted); background:var(--workspace-selected); padding:4px 8px; font-size:11px; }.notes-pagination { justify-content:space-between; padding:18px 0; color:var(--workspace-muted); font-size:13px; }.notes-pagination div { display:flex; align-items:center; gap:10px; }.notes-empty, .notes-error { padding:30px 0; color:var(--workspace-muted); }.notes-error { color:var(--workspace-danger); }
...
.note-row:focus-within { background: var(--workspace-hover); }
...
@media(max-width:700px) { .note-tag button { min-width:44px; min-height:44px; } .note-row-meta { max-width:100%; } }
</style>
