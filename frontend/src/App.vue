  ...
  <div class="shell dashboard-shell">
    ...
    <header>
      ...
      <div class="shell-actions">
        <RouterLink v-if="auth.isAuthenticated" class="settings-link" to="/settings" aria-label="Settings" title="Settings">
        ...
        <button v-if="auth.isAuthenticated" class="ghost" @click="logout">Sign out</button>
      </div>
    </header>
    <main id="main-content" tabindex="-1">
      <AuthView v-if="!auth.isAuthenticated" @authenticated="authenticated" /><RouterView
        v-else
      />
    </main>
