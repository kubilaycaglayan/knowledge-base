...
- [ ] **CH-01** Closing the card editor (Close, Escape, Ctrl/Cmd+Enter, or the
...
- [ ] **CH-02** The mark is an accent ring outside the card's border that
...
- [ ] **CH-03** With reduced motion, the ring shows without animation and is
