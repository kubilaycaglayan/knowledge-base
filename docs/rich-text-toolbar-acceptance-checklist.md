...
- [ ] **RT-01** One shared `RichTextToolbar` component (`role="toolbar"`,
...
- [ ] **RT-02** A text style menu offers Normal text, Heading 1, Heading 2,
...
- [ ] **RT-03** Icon buttons toggle bold, italic, underline, strikethrough,
...
- [ ] **RT-04** The toolbar is a single Tab stop. Arrow Left/Right, Home, and
...
- [ ] **RT-05** The toolbar stays on one row. At 390px it scrolls sideways
...
- [ ] **RT-06** Paragraphs have no gap between them, so a new line from Enter
