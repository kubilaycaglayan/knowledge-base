...
const required = [
  ...
  ['frontend/src/components/FloatingTimeTracker.vue', 'aria-label="Timer start"', 'active timer start editor label'],
  ...
  ['ios/Know/KnowApp.swift', 'accessibilityIdentifier("timer.label")', 'native timer label selector identifier'],
  ...
  ['ios/KnowUITests/KnowUITests.swift', 'app.buttons["timer.label"]', 'native UI test label selector target'],
